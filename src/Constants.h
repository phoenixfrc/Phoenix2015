...
struct FieldDistances
{
    ...
    static const int autoCrateDiff = 81 + 8; // 81 This number comes from the manual but may be a little off
    ...
    static const int intoAutoDiff = 48;//128; //This number comes from the manual but may be a little off
